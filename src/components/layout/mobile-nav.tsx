...
const navItems: NavItem[] = [
  ...
  { href: "/vehicles/new", label: "List", icon: <PlusCircle className="h-5 w-5" /> },
  { href: "/messages", label: "Messages", icon: <MessageSquare className="h-5 w-5" /> },
  { href: "/dashboard", label: "Profile", icon: <User className="h-5 w-5" /> },
];
...
export function MobileNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 glass border-t border-glass-border-light dark:border-glass-border-dark safe-area-bottom">
